...
You can make a combo of arc shot + normal shot: shoot an arrow up, so that it arcs and hits the enemy on the head. Charge another arrow from the side and try to sync both of the arrows so that at least one of them hits. I do that twice in the gif below -- first when fighting against the red-haired knight, and again when fighting against the burger knight (with the 2nd arrow stunning the knight, which lets the arc arrow do damage)
