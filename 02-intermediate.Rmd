...
Spamming quartershots in close combat is not very effective since your shots have small velocity and do half a heart of damage. They can be good for making a barrier if the enemy will die trying to pass it. As mentioned earlier, best way to use them is by having significant height advantage over the enemy, and then spamming quartershots, they will do 1 damage if they have time to gain enough velocity.
