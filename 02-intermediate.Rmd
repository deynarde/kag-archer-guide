...
Keep in mind that knights can crouch while shielding as well. In this case, you can also decide to not stomp them and just wait to get inside them first, and then shoot an arrow.
