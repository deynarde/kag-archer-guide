...
After doing that, you can shoot enemies in their back. In the gif below, first we flick ourselves with our grappling hook (momentum jump) then start holding S and letting go of other keys after hitting the ground while charging a halfshot at the same time.
...
If the enemy has their shield up, and you're close enough, sometimes (although not always -- this seems to be somewhat random, regardless of distance or type of arrow) shooting at the shield will make the keg fall. However, the most reliable way is to just shoot at the head whenever the enemy is shielding.

[24]

It works the same with lighting enemy kegs by fire arrows -- if the enemy is shielding, it may or may not prevent the keg from being lit. Again, best way is to just aim at the head, or just at the keg itself.
