...
This also works when stopped by 2 blocks.
...
If the enemy has their shield up, and you're close enough (less than around 10 blocks), sometimes (although not always -- this seems to be somewhat random, regardless of distance or type of arrow) shooting at the shield will make the keg fall. However, the most reliable way is to just shoot at the head whenever the enemy is shielding.
...
Shooting catapults or ballistas when they still have wheels attached makes them move. In some cases you can make a catapult or a ballista fall over, damaging it greatly. This however happens very rarely due to builders detaching wheels from vehicles right after unpacking them.
