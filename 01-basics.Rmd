...
They don't stun like full shots, have a lower velocity and travel less distance, but they do the same amount of damage - 1 heart. You should use them the most at mid-range fights and when supporting your knights - they're the most useful shots most of the time.

Keep in mind that if you shoot a half shot and it hits the enemy that was a bit more far away, it may lose velocity and do 0.5 heart of damage instead, like in the gif below.
...
Boulders can do 0.5, 1.5 and full health of damage, depending on the boulder's velocity. They sometimes bounce twice on an enemy head, which will add at least half a heart of damage. Below are some gifs demonstrating how boulders can be used in TDM.
...
<video style="display:block; max-width:100%; height:auto;" src="webm/01-basics/boulder4.webm" controls loop="loop" preload></video><br>
