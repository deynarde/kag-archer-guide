...
Many people don't know that in TDM, bought boulders will never do damage to the players team who bought it. This causes many people to use the boulder and cripple themselves. This mechanic is like that only in TDM though, boulders in CTF will damage your team if the last person holding it was an enemy.
[gif of boulder mechanics in tdm]
Boulders can do 0.5, 1.5 and full health of damage, depending on the boulders velocity. They can bounce twice(can be multiple times but very rarely happens.) on an enemy head, which will add atleast half a heart of damage.
